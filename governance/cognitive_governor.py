...
class CognitiveGovernor:
    ...
    def build_search_classification_prompt(
        ...
        return (
            ...
            "- french_foreign_policy: use when the message materially concerns "
            "continuities in French foreign policy, France's relations with the "
            "Muslim world, the Franco-Ottoman alliance, Ain Jalut, the Ottoman "
            "Empire, Russia, the Opium Wars, the Crimean War, Napoleon's Eastern "
            "policy, Napoleon III in Algeria, the Arab policy of France, or a "
            "historical connection between these subjects and a contemporary "
            "French political or demographic question.\n\n"
